...
public class StringUtils {
    ...
    // 判断字符的值 是否在字符串之中。
    public  static boolean whetherIsInStr(String searchKey,String dest){
        ...
        String[] withKeyWords=dest.split(",");
        for(String s:searchKeyWords){
            for(int i=0;i<withKeyWords.length;i++){
                if(withKeyWords[i].equals(s)){
                    return true;
                }
            }
        }
    ...
    public static boolean betweenIn(Integer age,Integer start,Integer end){
